# from here:
#
# https://github.com/lefticus/cppbestpractices/blob/master/02-Use_the_Tools_Avai lable.md Courtesy
# of Jason Turner
...
function(set_project_warnings project_name)
  ...
  if(${PROJECT_NAME}_BUILD_HEADERS_ONLY)
    ...
    target_link_options(${project_name} INTERFACE ${PROJECT_WARNINGS})
  else()
    target_compile_options(${project_name} PUBLIC ${PROJECT_WARNINGS})
    target_link_options(${project_name} PUBLIC ${PROJECT_WARNINGS})
  endif()
